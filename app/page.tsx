...
function getApiServices(): ApiServiceConfig[] {
  ...
  return [
    {
      name: 'order-service',
      url: process.env.SVC_ORDER_SERVICE_URL || 'http://cmnfnulx20001nieaihog5akg-project-1-order-service.space-cmnfnulx-space-1.svc.cluster.local:3000',
    },
    {
      name: 'user-service',
      url: process.env.SVC_USER_SERVICE_URL || 'http://cmnfnulx20001nieaihog5akg-project-1-user-service.space-cmnfnulx-space-1.svc.cluster.local:3000',
    },
    {
      name: 'auth-service',
      url: process.env.SVC_AUTH_SERVICE_URL || 'http://cmnfnulx20001nieaihog5akg-project-1-auth-service.space-cmnfnulx-space-1.svc.cluster.local:3000',
    },
    {
      name: 'payment-service',
      url: process.env.SVC_PAYMENT_SERVICE_URL || 'http://cmnfnulx20001nieaihog5akg-project-1-payment-service.space-cmnfnulx-space-1.svc.cluster.local:3000',
    },
  ];
}
...
export default async function Home() {
  ...
  const appName = process.env.APP_NAME || 'frontend-service';
